<template>
  <div class="wrapper">
    <svg id="生产线" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
      ...
      <g opacity="0.3">
        <circle :fill="color" cx="283.5" cy="283.5" r="229.6" />
      </g>
      <g>
        <path :fill="color" d="M268.5,518.6c-41.2-2.6-81-16-115.4-38.8l6.6-10c32.6,21.6,70.4,34.4,109.5,36.8L268.5,518.6z M307.5,517.9
      ...
      <g>
        <path :fill="color" d="M283.5,562.6c-19.9,0-39.8-2.1-59.2-6.3l5.3-24.4c17.6,3.8,35.7,5.7,53.9,5.7c45.8,0,90.7-12.3,129.9-35.6
